 ...
 * @author 90930034
 */
public class PublicCloud extends Resource {
    ...
    public PublicCloud(String name, String resourcePropFileName, RescourceLocation resLoc) throws FileNotFoundException, IOException {
        ...
        //paramValuesArrivalTime.add(ApplicationManager.getPNUMAPPSPERHOURMIN());
        //paramValuesArrivalTime.add(ApplicationManager.getPNUMAPPSPERHOURMAX());
        ...
        paramValuesArrivalTime.add(estimateMinProcessingTime() * 1.2);
        paramValuesArrivalTime.add(estimateMaxProcessingTime() * 1.5);
